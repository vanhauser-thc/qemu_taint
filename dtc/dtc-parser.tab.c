...
#line 1512 "dtc-parser.tab.c"
    break;

  case 9:
#line 151 "dtc-parser.y"
                {
			(yyval.re) = build_reserve_entry((yyvsp[-2].integer), (yyvsp[-1].integer));
		}
#line 1520 "dtc-parser.tab.c"
    break;
...
#line 1638 "dtc-parser.tab.c"
  ...
  case 19:
#line 246 "dtc-parser.y"
                {
			(yyval.proplist) = NULL;
		}
#line 1646 "dtc-parser.tab.c"
    break;
...
#line 1654 "dtc-parser.tab.c"
    break;

  case 21:
#line 257 "dtc-parser.y"
                {
			(yyval.prop) = build_property((yyvsp[-3].propnodename), (yyvsp[-1].data));
		}
#line 1662 "dtc-parser.tab.c"
    break;
...
#line 1753 "dtc-parser.tab.c"
    break;

  case 31:
#line 319 "dtc-parser.y"
                {
			(yyval.data) = data_add_marker((yyvsp[-1].data), LABEL, (yyvsp[0].labelref));
		}
#line 1761 "dtc-parser.tab.c"
    break;

  case 32:
#line 326 "dtc-parser.y"
                {
			(yyval.data) = empty_data;
		}
#line 1769 "dtc-parser.tab.c"
    break;
...
#line 1777 "dtc-parser.tab.c"
    break;

  case 34:
#line 334 "dtc-parser.y"
                {
			(yyval.data) = data_add_marker((yyvsp[-1].data), LABEL, (yyvsp[0].labelref));
		}
...
#line 457 "dtc-parser.y"
                                         { (yyval.integer) = (yyvsp[-2].integer) > (yyvsp[0].integer); }
#line 1936 "dtc-parser.tab.c"
    break;

  case 62:
#line 458 "dtc-parser.y"
                                           { (yyval.integer) = (yyvsp[-2].integer) <= (yyvsp[0].integer); }
#line 1942 "dtc-parser.tab.c"
    break;

  case 63:
#line 459 "dtc-parser.y"
                                           { (yyval.integer) = (yyvsp[-2].integer) >= (yyvsp[0].integer); }
#line 1948 "dtc-parser.tab.c"
    break;
...
#line 469 "dtc-parser.y"
                                      { (yyval.integer) = (yyvsp[-2].integer) + (yyvsp[0].integer); }
#line 1966 "dtc-parser.tab.c"
    break;

  case 68:
#line 470 "dtc-parser.y"
                                      { (yyval.integer) = (yyvsp[-2].integer) - (yyvsp[0].integer); }
#line 1972 "dtc-parser.tab.c"
    break;
...
#line 2046 "dtc-parser.tab.c"
    break;

  case 81:
#line 521 "dtc-parser.y"
                {
			(yyval.nodelist) = NULL;
		}
#line 2054 "dtc-parser.tab.c"
    break;

  case 82:
#line 525 "dtc-parser.y"
                {
...
#line 2062 "dtc-parser.tab.c"
  ...
  case 83:
#line 529 "dtc-parser.y"
                {
			ERROR(&(yylsp[0]), "Properties must precede subnodes");
			YYERROR;
		}
#line 2071 "dtc-parser.tab.c"
    break;
...
#line 2095 "dtc-parser.tab.c"
    break;

  case 87:
#line 549 "dtc-parser.y"
                {
			add_label(&(yyvsp[0].node)->labels, (yyvsp[-1].labelref));
			(yyval.node) = (yyvsp[0].node);
		}
#line 2104 "dtc-parser.tab.c"
    break;


#line 2108 "dtc-parser.tab.c"
