DEF_HELPER_FLAGS_2(taint_getload1, TCG_CALL_NO_RWG, void, env, tl)
DEF_HELPER_FLAGS_2(taint_getload2, TCG_CALL_NO_RWG, void, env, tl)
DEF_HELPER_FLAGS_2(taint_getload4, TCG_CALL_NO_RWG, void, env, tl)
DEF_HELPER_FLAGS_2(taint_getload8, TCG_CALL_NO_RWG, void, env, tl)
